...
- [EMBL-EBI - European Bioinformatics Institute database of molecular data repositories](https://www.ebi.ac.uk/services)
...
- [NIF - Neuroscience Information Framework, massive search engine for neuroscience data, tools, etc.](http://www.neuinfo.org/)
    - [NIF DISCO - Extensible Web DISCOvery tool](http://disco.neuinfo.org/webportal/discoDashboardShow.do)
...
- [OASIS - Cancer genomics portal](http://www.oasis-genomics.org/)
...
- [Databrary - Video data library for behavioral scientists](https://nyu.databrary.org/)
- [DataLad - Data package management system, easing the use of accessing open data sets](http://datalad.org/)
...
- [Ensembl - Vertebrate genome browser including BLAST, BLAT, BioMart, and VEP](http://www.ensembl.org/index.html?redirect=no)
...
- [OpenNeuro - Free and open platform for neuroimaging data (succeeds OpenfMRI)](https://openneuro.org/)
...
- [Open Optogenetics Hardware](https://web.stanford.edu/group/dlab/optogenetics/hardware.html)
